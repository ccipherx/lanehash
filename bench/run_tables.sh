...
H=lanehash,lanehash-vaes256,lanehash-aesni,lanehash-spec,gxhash,rapidhash-v3,xxh3,foldhash,ahash
...
taskset -c 3 $B throughput --rounds 5 --align 1 --hashes lanehash,gxhash,rapidhash-v3,xxh3 --sizes 256,1024,4096,65536 > docs/bench/throughput-L2-align1.csv 2>&1
# L1-resident: working set = 16 KiB
for cfg in "256 64" "1024 16" "4096 4" "16384 1"; do set -- $cfg
  taskset -c 3 $B throughput --rounds 5 --align 16 --nbuf $2 --hashes lanehash,lanehash-vaes256,lanehash-aesni,gxhash,rapidhash-v3,xxh3 --sizes $1 >> docs/bench/throughput-L1-align16.csv 2>&1
...
taskset -c 3 $B throughput --rounds 3 --align 16 --dram --hashes lanehash,gxhash,rapidhash-v3,xxh3 --sizes 1048576 > docs/bench/throughput-dram.csv 2>&1
