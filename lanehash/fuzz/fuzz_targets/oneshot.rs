...
fuzz_target!(|input: &[u8]| {
    ...
    let want = lanehash::aes::spec::hash128_spec(&data, seed);
    assert_eq!(lanehash::aes::hash128(&data, seed), want, "hash128");
    assert_eq!(lanehash::aes::hash64(&data, seed), want as u64, "hash64");
    if data.len() > lanehash::aes::SHORT_MAX {
